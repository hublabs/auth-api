...
import (
	...
	"github.com/hublabs/auth-api/controllers"
...
func main() {
	...
	xormEngine, err := xorm.NewEngine(configutil.DataBaseDriver, configutil.AuthApiConnection)
	if err != nil {
		panic(err)
	}
...
func InitControllers(e *echo.Echo) {
	...
	controllers.AuthApiController{}.Init(v1Group)
}
